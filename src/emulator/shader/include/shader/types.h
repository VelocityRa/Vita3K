...
#define SWIZZLE_CHANNEL_3(ch1, ch2, ch3) {SwizzleChannel::_##ch1, SwizzleChannel::_##ch2, SwizzleChannel::_##ch3}
#define SWIZZLE_CHANNEL_4(ch1, ch2, ch3, ch4) {SwizzleChannel::_##ch1, SwizzleChannel::_##ch2, SwizzleChannel::_##ch3, SwizzleChannel::_##ch4}
...
struct DestinationMask {
    ...
    DestinationMask(Imm4 val) : val(val) {}
};
#pragma pack(pop)
